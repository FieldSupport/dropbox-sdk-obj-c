...
/// Mapping of urls for files that were unsuccessfully uploaded to any network errors that were encounted.
@property (atomic, readonly) NSMutableDictionary<NSURL *, DBRequestError *> *fileUrlsToNetworkErrors;
